...
class TLE:
    ...
    def __init__(self, name: str, raw_line_1: str, raw_line_2: str, perform_check=False,
                 body_mu=3.986004418 * (10 ** 14)):
        ...
        if self.catalogue_num != raw_line_2[2:7].strip():
            raise Exception("Catalogue Number Mismatched Between Two Lines: {} vs {}".format(self.catalogue_num,
                                                                                             raw_line_2[2:7].strip()))
        ...
        self.semi_major_axis = (self.body_mu ** (1. / 3)) / (((2 * self.mean_motion * pi)) / 86400) ** (
                    2. / 3)  # correct
